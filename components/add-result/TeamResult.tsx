...
const TeamResult = ({ players, title, player1HandleChange, player2HandleChange, pointsHandleChange }:
    ...
    return (
        <Grid container spacing={2} pl={2} pr={2} pb={2}>
            ...
            <Grid item xs={12} md={4}><PlayerSelect players={players} title="Pelaaja 1" handleChange={player1HandleChange}
                teamResultTestTitle={title} /></Grid>
            <Grid item xs={12} md={4}><PlayerSelect players={players} title="Pelaaja 2" handleChange={player2HandleChange}
                teamResultTestTitle={title} /></Grid>
